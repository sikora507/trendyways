...
describe ("Indicators", function () {
  ...
  it ("Money Flow Index test", function ()
  {
    ...
    var mfiResult = Trendyways.indicators.mfi (values, 14);
   ...
   */
   it ("MACD test", function () {
    ...
    var macdResults = Trendyways.indicators.macd (testData);
    assert.equal (Trendyways.utils.flat(macdResults,"macd").length, macdTest.length, "MACD values match length ");
    for (var i = 0; i < Trendyways.utils.flat(macdResults,"macd").length; i++)
    {
      assert.deepEqual (macdResults[i].macd.line.toFixed(5), macdTest[i].toFixed(5), "Testing MACD value " + i);
    }
    assert.equal (Trendyways.utils.flat(macdResults,"signal").length, signalTest.length, "MACD signal values match length");
    for (var i = 0; i < Trendyways.utils.flat(macdResults,"signal").length; i++)
    {
 ...
 */
 it ("Momentum Test", function () {
  ...
  var momentumValues = Trendyways.indicators.momentum (values, 1);
  ...
  var momentumValues3 = Trendyways.indicators.momentum (values, 3);
 ...
 */
 it ("Rate of Change", function () {
   ...
   var rocValues = Trendyways.indicators.roc (values, 1);
   ...
   var rocValues3 = Trendyways.indicators.roc (values, 3);
  ...
  */
  it ("RSI test", function () {
    ...
    37.32, 33.09, 37.78];
    var result = Trendyways.indicators.rsi (values, 14);
  ...
  it ("ATR test", function () {
    ...
    var result = Trendyways.indicators.atr(values);
